...
export default function CapturePage() {
        ...
        <Card className="max-w-md p-8 text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Before capturing images, you need to upload a 2D floor plan and configure GPS mapping. This ensures
              accurate position tracking during capture.
            </p>
          </div>
  ...
  return <CameraCapture floorPlan={floorPlan} />
}
